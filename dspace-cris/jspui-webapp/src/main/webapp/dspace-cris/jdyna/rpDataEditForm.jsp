...
<c:set var="dspace.layout.head.last" scope="request">  
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/jdyna_custom.css" type="text/css" />    
    ...
    * html .ui-autocomplete {
    ...
    var replaceWithTextArea = function() {
        if (document.getElementById('anagraficaProperties[biography][0]') !== null) {
            var inputToReplace = document.getElementById('anagraficaProperties[biography][0]');
            var replacementTextarea = document.createElement("textarea");
           
            inputToReplace.parentNode.insertBefore(replacementTextarea, inputToReplace);
            replacementTextarea.value = inputToReplace.value;

			inputToReplace.setAttribute("type", "hidden");
			inputToReplace.removeAttribute("name");
			inputToReplace.removeAttribute("onchange");
			inputToReplace.removeAttribute("id");

			replacementTextarea.setAttribute("name", "anagraficaProperties[biography][0]");
			replacementTextarea.setAttribute("onchange", "validateAnagraficaProperties('anagraficaProperties[biography][0]', 'RPAdditionalFieldStorage', 'biography');");
			replacementTextarea.setAttribute("id", "anagraficaProperties[biography][0]");
			replacementTextarea.setAttribute("rows", "5");
			replacementTextarea.setAttribute("cols", "55");
